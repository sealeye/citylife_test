...
gulp.task('default', function () {
    gulp.start('sprite', 'twig', 'styles', 'scripts', 'img', 'cache');
});

// Запуск живой сборки
gulp.task('live', function () {
    gulp.start('sprite', 'twig', 'styles', 'scripts', 'img', 'watch', 'server');
});

// Cборка с вотчем без браузерсинка
gulp.task('no-server', function () {
    gulp.start('sprite', 'twig', 'styles', 'scripts', 'img', 'cache', 'watch');
});
